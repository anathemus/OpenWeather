...
{
    // started by making my own model class, then discovered pasting from json
    public class OpenWeatherModel
    {
        public string City { get; set; }
        public string StateZip { get; set; }
        // simple  boolean for precipitation, if > 0 true, else false
    ...
    // below classes pasted from json to get current weather
